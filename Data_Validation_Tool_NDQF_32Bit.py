...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.pushButton_34.setText(_translate("TabWidget", "दिशानिर्देश"))
    ...
    try:
        def onSelectDistrict(self, index):
            ...
            #df.rename(columns={df.filter(regex='^[D][i][s][t][r][i][c][t]|^ +[D][i][s][t][r][i][c][t]/i').columns[0]: 'col_5',},inplace=True)
        ...
        self.pushButton_13.setText('Not Available')
        self.pushButton_13.setEnabled(False)
        self.pushButton_22.setText('उपलब्ध नहीं है')
    ...
    try:
        ...
        self.pushButton_14.setText('Not Available')
        self.pushButton_14.setEnabled(False)
        self.pushButton_23.setText('उपलब्ध नहीं है')
    ...
    try:
        ...
        self.pushButton_15.setText('Not Available')
        self.pushButton_15.setEnabled(False)
        self.pushButton_24.setText('उपलब्ध नहीं है')
    ...
    try:
        ...
        self.pushButton_27.setText('Not Available')
        self.pushButton_27.setEnabled(False)
        self.pushButton_31.setText('उपलब्ध नहीं है')
    ...
    try:
        ...
        self.pushButton_29.setText('Not Available')
        self.pushButton_29.setEnabled(False)
        self.pushButton_33.setText('उपलब्ध नहीं है')
    ...
    try:
        ...
        self.pushButton_28.setText('Not Available')
        self.pushButton_28.setEnabled(False)
        self.pushButton_32.setText('उपलब्ध नहीं है')
        self.pushButton_32.setEnabled(False)
    ...
    # Display methodology pdf in browser
    def UserManual(self):
        os.system('start User_Manual.pdf')
